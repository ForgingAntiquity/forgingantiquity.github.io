...
We provide here a list of those fake papyri and related manuscripts which have come to the notice of the project so far, as a resource for those who are interested in the topic. The table below may be sorted and filtered, or items searched for. This version of the database was uploaded on 3 July 2026. The full csv file is available in the Macquarie University Data Repository, and a csv file reflecting selections made in the table can also be downoaded from this page. A [description](#Description) of the table and its fields may be found below the table, along with information on [citing the database and licensing](#Citation and Licensing) and a [bibliography of works cited](#Bibliography). A [full description of the typology](/typology) is available on a separate page.
...
This version of the database was uploaded on 3 July 2026. it is licensed under a CC-BY-NC [Creative Commons Attribution-NonCommercial 4.0 International License](https://creativecommons.org/licenses/by-nc/4.0/).
